...
atualizarPaginaGerenciarServidores = () => {
    ...
    return (
      <div>
        ...
        <Modal size={size} open={open} onClose={this.close}>
          <Modal.Header>Atualizando Servidor {this.props.servidor._id}</Modal.Header>
          <Modal.Content>
